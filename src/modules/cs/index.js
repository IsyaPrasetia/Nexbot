    ...
    sock.ev.on('messages.upsert', async (m) => {
        ...
        try {
            ...
            if (command === '1') {
                ...
                await sendReply(sock, userJid, { 
                    text: "Halo kak👋🏻.\nSaat ini kami menyelenggarakan Webinar Internasional sebagai berikut:\n\n1. *Polytrauma* (1 Agt) 3 SKP\n\nInfo Pendaftaran:\nwww.pondoksehatindonesia.com\n\n━━━━━━━━━━━━━━━\n*Webinar Nasional (Arteria Medpro)* (2 SKP All Nakes):\n\n📅 *2 Agustus 2026*\n• *Manajemen Antibiotik dalam Praktik Klinis: Efektivitas Terapi dan Mencegah Resistensi*\n• *Syok Anafilaktik dalam Kegawatdaruratan: Strategi Penanganan Awal dan Perawatan Lanjutan*\n• *Optimalisasi Interprofesional Kolaborasi Pengelolaan dan Tatalaksana Obat Emergensi di Layanan Kesehatan*\n\n🔥 *PROMO 3 WEBINAR NASIONAL 2 AGUSTUS 2026!*\n🚨KUOTA WEBINAR TERBATAS. 3 WEBINAR ARTERIA MEDPRO (2 Agustus 2026)‼️\n\n💰 Biaya Webinar: *Rp 40.000,-*\n📚 TOTAL: *6 SKP*\n\nLangsung daftar 👉 https://www.arteriamedpro.com/promo\n\nInfo Pendaftaran:\nwww.arteriamedpro.com"
                });
                await sendReply(sock, userJid, { 
                    text: "📝 *TERTARIK UNTUK MENDAFTAR?*\n\n• Ketik *2* untuk panduan pendaftaran mandiri (via website)\n• Ketik *3* untuk pendaftaran langsung (isi form di chat ini)\n\n_Bisa ketik *0* untuk kembali ke Menu Utama._"
                });
            } 
            else if (command === '2') {
                ...
                await sendReply(sock, userJid, { 
                    text: "✍️ *PENDAFTARAN LANGSUNG*\n\nBaik Kak, Untuk melakukan pendaftaran langsung Kakak Silakan Mengisi data ini:\n\n• *Nama Lengkap* :\n• *Email Plataran Sehat* :\n• *NIK KTP* :\n• *Profesi* :\n• *Webinar Tanggal* :\n\nMohon disertakan *screenshot bukti pembayaran* yang telah dilakukan.\n\n📌 *Informasi Pembayaran:*\n• *Webinar Internasional (PT Pondok Sehat Indonesia):*\n  Transfer ke *No. Rek Mandiri 1760005174980* a.n *PT. Pondok Sehat Indonesia*\n\n━━━━━━━━━━━━━━━\n\n• *Webinar Nasional (Arteria Medpro):*\n  Transfer ke *No. Rek Mandiri 1550015927075* a.n *CV. Arteria Medika Profesional*\n\n_(Silakan **SALIN** pesan ini, isi datanya, lalu kirim kembali ke chat ini beserta bukti transfer)_\n\n_Bisa ketik *0* untuk kembali ke Menu Utama._" 
                });
            }
            else if (command === '4') {
                ...
                await sendReply(sock, userJid, { 
                    text: "⚠️ *KENDALA VERIFIKASI / ERROR PADA SISTEM*:\n\nBaik Kak, mohon bantuannya untuk melengkapi data berikut guna mempercepat proses pengecekan oleh tim sistem kami:\n\n• *Nama Lengkap* :\n• *Email Plataran Sehat* :\n• *NIK KTP* :\n• *Profesi* :\n\n_(Silakan salin pesan ini dan isi data di atas dengan benar)_\n\n📌 *Catatan Tambahan:* Kami menjamin keamanan dan kerahasiaan seluruh data pribadi yang Anda kirimkan.\n\n💡 *Tips:* Jika Kakak mengalami kendala pada proses upload bukti transfer, mohon sertakan foto bukti transfer secara langsung di chat ini beserta data di atas agar tim kami dapat segera membantu mengecek statusnya.\n\n_Bisa ketik *0* untuk kembali ke Menu Utama._" 
                });
            } 
            else if (command === '5') {
                ...
                await sendReply(sock, userJid, {
                    text: "🎟️ *FORM KLAIM VOUCHER WEBINAR*\n\nUntuk memproses klaim voucher Anda, mohon lengkapi dan isi data validasi di bawah ini dengan benar:\n\n• *Nama Lengkap* :\n• *Email Plataran Sehat* :\n• *NIK KTP* :\n• *Profesi* :\n• *Judul Webinar & Tanggal* :\n\n_(Silakan **SALIN** pesan ini, isi datanya, lalu kirim kembali ke chat ini)_\n\n📌 *Ketentuan Klaim:* Tim kami akan melakukan verifikasi kecocokan data Anda dengan sistem riwayat transaksi. Proses pengecekan antrean voucher membutuhkan waktu maksimal 1x24 jam.\n\n_Bisa ketik *0* untuk kembali ke Menu Utama._"
                });
            }
            else if (command === '6') {
